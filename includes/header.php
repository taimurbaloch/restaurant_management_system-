            ...
            <ul>
                ...
                <!--///////----- for messages count -----////////-->
                    <?php
                            ...
                            $q = "SELECT COUNT(*) AS total FROM contact_messages";
                    ...
                    ?>
                <li>
                    <a href="contact/list.php"><i class="fa-solid fa-envelope">
                           
                         </i><sup> <?php echo $total_messages; ?> </sup><span class="ml-2">Messages </span>
